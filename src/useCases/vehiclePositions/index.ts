...
const createVehiclePositionUseCase = new CreateVehiclePositionUseCase(vehiclePositionRepositoryPostgres);
const getAllVehiclesPositionsUseCase = new GetAllVehiclesPositionsUseCase(vehiclePositionRepositoryPostgres);
const getOneVehiclePositionUseCase = new GetOneVehiclePositionUseCase(vehiclePositionRepositoryPostgres);
const updateVehiclePositionUseCase = new UpdateVehiclePositionUseCase(vehiclePositionRepositoryPostgres);
const deleteVehiclePositionUseCase = new DeleteVehiclePositionUseCase(vehiclePositionRepositoryPostgres);
