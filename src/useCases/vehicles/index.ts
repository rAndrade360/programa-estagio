...
const createVehicleUseCase = new CreateVehicleUseCase(vehicleRepositoryPostgres);
const getAllVehiclesUseCase = new GetAllVehiclesUseCase(vehicleRepositoryPostgres);
const getOneVehicleUseCase = new GetOneVehicleUseCase(vehicleRepositoryPostgres);
const updateVehicleUseCase = new UpdateVehicleUseCase(vehicleRepositoryPostgres);
const deleteVehicleUseCase = new DeleteVehicleUseCase(vehicleRepositoryPostgres);
